...
var author$project$Main$openShiftProjectsDecoder = A2(
...
var author$project$Main$getOpenShiftProjects = F2(
	function (openShiftUrl, authenticationToken) {
		return elm$http$Http$request(
			{
				body: elm$http$Http$emptyBody,
				expect: A2(elm$http$Http$expectJson, author$project$Main$GotOpenShiftProjects, author$project$Main$openShiftProjectsDecoder),
...
var author$project$Main$subscriptions = function (submarine) {
		...
		switch (msg.$) {
			...
			case 'UpdateRuntime':
				...
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			case 'UpdateReplicas':
				var newReplicas = msg.a;
				var _n1 = elm$core$String$toInt(newReplicas);
				if (_n1.$ === 'Just') {
					var newReplicasNumber = _n1.a;
					return _Utils_Tuple2(
						_Utils_update(
							submarine,
							{
								replicas: elm$core$Maybe$Just(newReplicasNumber)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							submarine,
							{replicas: elm$core$Maybe$Nothing}),
						elm$core$Platform$Cmd$none);
				}
			case 'SelectIncremental':
				return _Utils_Tuple2(
					_Utils_update(
						submarine,
						{incremental: !submarine.incremental}),
					elm$core$Platform$Cmd$none);
			case 'UpdateReference':
				...
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			case 'UpdateContextDirectory':
				var newContextDir = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						submarine,
						{contextDir: newContextDir}),
					elm$core$Platform$Cmd$none);
			case 'GotOpenShiftProjects':
				var result = msg.a;
				if (result.$ === 'Ok') {
					if (result.a.b) {
						var _n3 = result.a;
						var firstProject = _n3.a;
						var otherProjects = _n3.b;
						return _Utils_Tuple2(
							_Utils_update(
								submarine,
								{
									openShiftProjects: A2(
					...
					return _Utils_Tuple2(
						_Utils_update(
							submarine,
							{
								openShiftProjects: author$project$Main$Error(error)
							}),
						elm$core$Platform$Cmd$none);
				}
			default:
				...
				if (_n4.$ === 'Success') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							submarine,
							{
								openShiftProjects: A2(author$project$Main$Success, projects, newOpenShiftProject)
							}),
						elm$core$Platform$Cmd$none);
				} else {
...
var author$project$Main$UpdateContextDirectory = function (a) {
	return {$: 'UpdateContextDirectory', a: a};
};
var author$project$Main$UpdateGitUrl = function (a) {
	return {$: 'UpdateGitUrl', a: a};
};
...
var author$project$Main$viewOpenShiftProjects = function (submarine) {
	var _n0 = submarine.openShiftProjects;
	switch (_n0.$) {
		case 'Loading':
			return _List_fromArray(
				[
					elm$html$Html$text('Loading OpenShift projects...'),
		...
		case 'Success':
			...
			return _List_fromArray(
				[
					elm$html$Html$text('OpenShift projects: '),
					A2(
					elm$html$Html$select,
					_List_fromArray(
						[
							elm$html$Html$Events$onInput(author$project$Main$ChangeOpenShiftProject)
						]),
					A2(
						elm$core$List$map,
						function (p) {
		...
		default:
			...
			switch (errorHttp.$) {
				case 'BadUrl':
					...
					return _List_fromArray(
						[
							elm$html$Html$text('No valid URL for OpenShift projects.'),
							A2(elm$html$Html$br, _List_Nil, _List_Nil)
						]);
				case 'NetworkError':
					return _List_fromArray(
						[
							elm$html$Html$text('Network error while loading OpenShift projects.'),
							A2(elm$html$Html$br, _List_Nil, _List_Nil)
						]);
				case 'BadStatus':
					var statusCode = errorHttp.a;
					return _List_fromArray(
						[
							elm$html$Html$text('Bad status code while loading OpenShift projects: '),
							elm$html$Html$text(
				...
				default:
					return _List_fromArray(
						[
							elm$html$Html$text('Error while loading OpenShift projects.'),
							A2(elm$html$Html$br, _List_Nil, _List_Nil)
						]);
			}
	}
};
var author$project$Main$UpdateReplicas = function (a) {
	return {$: 'UpdateReplicas', a: a};
};
var elm$html$Html$input = _VirtualDom_node('input');
var elm$html$Html$Attributes$placeholder = elm$html$Html$Attributes$stringProperty('placeholder');
var author$project$Main$viewReplicas = function (submarine) {
	var _n0 = submarine.replicas;
	if (_n0.$ === 'Just') {
		var replicas = _n0.a;
		return _List_fromArray(
			[
				elm$html$Html$text('Replicas: '),
				A2(
				elm$html$Html$input,
				_List_fromArray(
					[
						elm$html$Html$Attributes$placeholder('Replicas'),
						elm$html$Html$Attributes$value(
						elm$core$String$fromInt(replicas)),
						elm$html$Html$Events$onInput(author$project$Main$UpdateReplicas)
					]),
				_List_Nil),
				A2(elm$html$Html$br, _List_Nil, _List_Nil)
			]);
...
var author$project$Main$SpringBoot = {$: 'SpringBoot'};
var author$project$Main$UpdateRuntime = function (a) {
	return {$: 'UpdateRuntime', a: a};
};
...
var author$project$Main$viewRuntime = function (runtime) {
	...
	var isQuarkusSelected = function () {
		if (runtime.$ === 'Quarkus') {
			return true;
		} else {
			return false;
		...
		[
			...
			_List_fromArray(
				[
					...
					elm$html$Html$Attributes$name('runtime'),
					elm$html$Html$Attributes$checked(isQuarkusSelected),
					elm$html$Html$Events$onClick(
					author$project$Main$UpdateRuntime(author$project$Main$Quarkus))
				]),
			_List_Nil),
			elm$html$Html$text('Quarkus'),
			A2(
			elm$html$Html$input,
			_List_fromArray(
				[
					elm$html$Html$Attributes$type_('radio'),
					elm$html$Html$Attributes$name('runtime'),
					elm$html$Html$Attributes$checked(isSpringBootSelected),
					elm$html$Html$Events$onClick(
					author$project$Main$UpdateRuntime(author$project$Main$SpringBoot))
				]),
			_List_Nil),
			elm$html$Html$text('SpringBoot'),
			A2(elm$html$Html$br, _List_Nil, _List_Nil)
		]);
};
...
var author$project$Main$view = function (submarine) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_Utils_ap(
					_List_fromArray(
						[
							elm$html$Html$text('OpenShift URL: '),
							elm$html$Html$text(submarine.openShiftUrl),
							A2(elm$html$Html$br, _List_Nil, _List_Nil)
						]),
					_Utils_ap(
				...
				_List_fromArray(
					[
						elm$html$Html$text('Submarine app custom resource YAML: '),
						A2(
...
_Platform_export({'Main':{'init':author$project$Main$main(
	A2(
		...
		function (openShiftUrl) {
			return A2(
				elm$json$Json$Decode$andThen,
				function (authenticationToken) {
					return elm$json$Json$Decode$succeed(
						{authenticationToken: authenticationToken, openShiftUrl: openShiftUrl});
				},
				A2(elm$json$Json$Decode$field, 'authenticationToken', elm$json$Json$Decode$string));
		},
		A2(elm$json$Json$Decode$field, 'openShiftUrl', elm$json$Json$Decode$string)))(0)}});}(this));